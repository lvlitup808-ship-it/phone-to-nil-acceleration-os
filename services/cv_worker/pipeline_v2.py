...
from services.cv_worker.events.detector import detect_events
...
def _synthetic_risk(judge, clip_meta: dict) -> str:
...
def is_cue_actionable(cue: dict, athlete_context: dict | None = None, judge=None) -> dict:
    from packages.judgment.client import JudgmentClient
...
def _write_debug(folder: Path, seq, calibration, events) -> dict[str, str]:
    import numpy as np
